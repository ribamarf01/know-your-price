  ...
  return (<>
    <header className="w-full h-16 bg-rich-black-fogra flex items-center justify-between fixed top-0 z-10">
      ...
      <ul className='flex items-center mr-8'>
        ...
        <li className='px-3 ml-3 py-1 rounded text-white bg-rhythm hover:bg-independence hover:text-alice-blue duration-300 transition-all cursor-pointer font-medium text-lg font-poppins tracking-tighter'>Calculadora</li>
      </ul>
    </header>
  </>)
